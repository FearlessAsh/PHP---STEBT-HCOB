...
if (isset($_SESSION['userName'])) { 
    ...
    $services = "<a href='CategoryServices.php'> Services </a> ";
    } else { $services = "";}
...
<div id="container" class="auto-style8" style="width: 860px">
	...
	<div id="masthead" style="width: 860px">
		<img alt="" height="66" src="images/logo.gif" width="180px" /><p class="auto-style5">
	...
	<div id="navigation">
		...
		<ul>
			...
			<li ><a href="<?php $homeLink ?>">Home</a></li>
	...
	<div id="page_content" style="height:auto;">
		<!-- Begin Left Column -->
		<div id="left-nav" style="left: 0px; top: 0px; width: 160px; height: auto;">
			<h2>Categories</h2>
                        <p>&nbsp;</p>
			<p> <a href='CategoryComputers.php'> Computers </a> </p>
			<p>&nbsp;</p>
			<p><a href='CategoryClothing.php'> Clothing </a> </p>
			<p>&nbsp;</p>
			<p><a href='CategoryElectronics.php'> Electronics </a> </p>
			<p>&nbsp;</p>
			<p><a href='CategoryBooks.php'> Books </a> </p>
			<p>&nbsp;</p>
			<p><a href='CategoryHomeDecor.php'> Home Decor </a> </p>
			<p>&nbsp;</p>
			<p><a href='CategoryMisc.php'> Miscellaneous </a> </p>
			<p>&nbsp;</p>
